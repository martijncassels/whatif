...
.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
    $routeProvider
        ...
        .when('/workshops/view/:id',{templateUrl: 'partials/ws/viewworkshop', controller: 'WSViewCtrl', controllerAs: 'vm', access: {restricted: true}})
        .when('/workshops1/view/:id',{templateUrl: 'partials/ws/viewworkshop1', controller: 'WSViewCtrl', controllerAs: 'vm', access: {restricted: true}})
